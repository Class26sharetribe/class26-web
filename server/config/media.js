...
module.exports = {
  r2: {
    ...
    deliveryUrlExpiration: R2_DELIVERY_URL_EXPIRATION, // 6 months for delivery URLs
  },
  ...
  maxFileSizeByCategory: {
    ...
    pdf: MAX_DOCUMENT_SIZE, // 20MB
    document: MAX_DOCUMENT_SIZE, // 20MB
  },
  // Storage paths
  storagePaths: {
    listings: 'listings',
