...
const ExpertConductPolicyContent = props => {
...
ExpertConductPolicyContent.propTypes = {
  inProgress: bool,
...
export default compose(connect(mapStateToProps, mapDispatchToProps))(ExpertConductPolicyContent);

export { ExpertConductPolicyContent };
