...
const CommunityGuidelinesContent = props => {
...
CommunityGuidelinesContent.propTypes = {
  inProgress: bool,
...
export default compose(connect(mapStateToProps, mapDispatchToProps))(CommunityGuidelinesContent);
